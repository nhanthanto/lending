...
ActiveRecord::Schema.define(version: 20171003060742) do
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["borrower"], name: "index_transactions_on_borrower"
    t.index ["borrower_id"], name: "index_transactions_on_borrower_id"
    t.index ["lender"], name: "index_transactions_on_lender"
